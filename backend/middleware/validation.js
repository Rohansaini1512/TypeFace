...
const validateTransactionQuery = [
  ...
  query('sortBy')
    .optional()
    .isIn(['date', 'amount', 'created_at', 'category'])
    .withMessage('Sort by must be one of: date, amount, created_at, category'),
...
const validateFileUpload = [
  body('type')
    .isIn(['receipt', 'statement'])
    .withMessage('Upload type must be either "receipt" or "statement"'),
